<template>
  <div class="praise-wrapper">
    <flutter @complete="onComplete">
      <heart class="heart-wrap" v-for="item of options" :key="item"></heart>
    </flutter>
    <tap>
      <div class="praise-tap" v-show="isTap"></div>
    </tap>
    <div class="praise-btn-wrap" @click="onTap">
