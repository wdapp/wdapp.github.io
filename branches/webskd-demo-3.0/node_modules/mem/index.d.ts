...
declare const mem: {
     ...
     */
        <ArgumentsType extends unknown[],
            ReturnType extends unknown,
            CacheKeyType extends unknown>(fn: (...arguments: ArgumentsType) => ReturnType,
                                          options?: mem.Options<ArgumentsType, CacheKeyType, ReturnType>): (...arguments: ArgumentsType) => ReturnType;
     ...
     */
    clear<ArgumentsType extends unknown[], ReturnType extends unknown>(fn: (...arguments: ArgumentsType) => ReturnType): void;
